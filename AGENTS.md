...
| Standalone psychological analysis engine | `docs/sandbox-analysis-engine-charter.md`, `docs/sandbox-analysis-engine-phase-1.md`, `docs/sandbox-analysis-expert-rubric.md`, `docs/sandbox-analysis-calibration-dataset.md` |
...
| Standalone analysis engine contracts, schemas, migrations, rubric, calibration manifest | `npm run build`, `npm run qa:analysis-spec`, `npm run qa:analysis-engine`, `npm run qa:snapshot-contract` |
