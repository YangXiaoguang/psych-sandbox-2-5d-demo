...
| Standalone analysis engine | Fact/Feature/Hypothesis stay separate; process fidelity is honest; expert rubric and calibration manifest remain versioned and machine-valid. | `npm run build`, `npm run qa:analysis-spec`, `npm run qa:snapshot-contract`. |
