...
import { Cheeks, EyePair, Smile, TOY_DARK, ToyHighlight, ToyMaterial, type Vec3 } from "./toys/toyPrimitives";
import { PersonToy } from "./toys/PersonToy";
  ...
  return (
    ...
    >
      ...
      <ToyDropShadow
        ...
        radius={getShadowRadius(modelRecipe.kind) * (dragging ? 1.08 : hovered ? 1.04 : 1)}
      />
